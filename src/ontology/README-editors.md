These notes are for the EDITORS of onto-publ-demo
...
Make sure you have an ID range in the [idranges file](onto-publ-demo-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [onto-publ-demo-edit.owl](onto-publ-demo-edit.owl)

** DO NOT EDIT onto-publ-demo.obo OR onto-publ-demo.owl in the top level directory **

[../../onto-publ-demo.owl](../../onto-publ-demo.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/alejgh/onto-publ-demo) for details.
 ...
 * [onto-publ-demo-idranges.owl](onto-publ-demo-idranges.owl)
...
There are two ways to include new classes in an import module
 ...
 2. Add to the imports/onto-publ-demo_terms.txt file
...
Note: the onto-publ-demo_terms.txt file may include 'starter' classes seeded from
...
This generates derived files such as onto-publ-demo.owl and onto-publ-demo.obo and places
 ...
 * https://github.com/alejgh/onto-publ-demo/releases
 * https://github.com/alejgh/onto-publ-demo/releases/new
...
what is in the `owl:versionIRI` of the derived onto-publ-demo.owl (`data-version` in
onto-publ-demo.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/onto-publ-demo.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/onto-publ-demo/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/alejgh/onto-publ-demo.svg?branch=master)](https://travis-ci.org/alejgh/onto-publ-demo)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/alejgh](https://travis-ci.org/profile/alejgh)
 2. click the "Sync account" button
 3. Click the tick symbol next to onto-publ-demo
